...
/**
 * @ClassName: ClassUtil
 * @Description: JAVA获取同一路径下所有子类或接口实现类
 * @author cyg(chenyangao@lakala.com)
 * @date 2017年7月19日下午4:43:28
 *
 * 
...
public class ClassUtil {
	public static void main(String[] args) {
		try {
			...
			for (Class<?> c : getAllAssignedClass(TimeChange.class)) {
				System.out.println(c.getName());
			}
			System.out.println("子类：");
			for (Class<?> c : getAllAssignedClass(UserController.class)) {
				System.out.println(c.getName());
			}
